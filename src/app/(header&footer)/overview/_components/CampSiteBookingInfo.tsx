...
function CampSiteBookingInfo({
  ...
  return (
    <article className='flex flex-col gap-16pxr mobile359:px-16pxr'>
      ...
      <ul className='flex flex-col gap-4pxr rounded-xl bg-white px-24pxr py-20pxr text-gray600 shadow-overView font-body2-medium mobile:font-caption1-medium mobile359:p-16pxr'>
        <li>
          · 매너 타임 :
          <span>
