...
function CustomerReviews({ id, sectionRef }: CustomerReviewsProps) {
  const [showAll, setShowAll] = useState(false);
  return (
    <section
      ref={sectionRef}
      id={id}
      className='flex scroll-mt-168pxr flex-col gap-20pxr border-b border-gray200 pb-40pxr pt-20pxr mobile:pl-20pxr mobile359:pl-16pxr'
    >
          ...
          <div className='flex flex-col gap-16pxr'>
            ...
            <div className='flex flex-col gap-8pxr mobile:pr-20pxr mobile359:pr-16pxr'>
              ...
              <p className='text-gray500 font-body2'>
                {showAll
                  ? '친구랑 둘이서 처음 가 본 캠핑이었는데 엄청 친절하시고 조용해서쉬기에도 너무 좋았어요! 자연 향기 너무 힐링되고 좋았어요! 친구도너무 마음에 든다구 하더라구요 ㅎㅎ ! 다음 캠핑갈 때도 이용하고싶어요!'
                  : '친구랑 둘이서 처음 가 본 캠핑이었는데 엄청 친절하시고 조용해서 쉬기에도 너무 좋았어요! 자연 향기 너무 힐링되고 좋았어요! 친구도 너무 마음에 든다구 하더라구요 ㅎㅎ ! 다음 캠핑갈 때도 이용하고싶어요!'.slice(
                      0,
                      30,
                    )}
              </p>
