  ...
  return (
    <div className='m-auto w-full max-w-1360pxr'>
      ...
      <main className='relative flex w-full flex-row-reverse justify-between gap-40pxr pt-40pxr mobile:relative mobile:pt-20pxr tablet1079:relative'>
        <aside className='sticky top-40pxr h-fit w-340pxr mobile:absolute mobile:right-20pxr mobile:top-20pxr mobile:w-fit mobile359:right-16pxr tablet1079:absolute tablet1079:right-0pxr tablet1079:top-40pxr tablet1079:w-fit'>
          <MiniMapContainer />
        </aside>
        <div>
          ...
          <section className='flex flex-col gap-24pxr pt-24pxr'>
            <div className='flex flex-col gap-16pxr'>
              <h3 className='text-black font-title2-semibold mobile:px-20pxr mobile:font-title3-bold mobile359:px-16pxr'>
                배치도
              </h3>
              <div className=''>
                <Image
