      ...
      <div className='flex-center searchPageOverFlow h-full w-full'>
        {mapSize !== 'map' && (
          ...
          >
            ...
            <div className='flex h-full w-full flex-col gap-48pxr mobile:gap-64pxr'>
              {campPlaceData && (
                <CampSearchList
