  ...
  return (
    ...
    >
        ...
        {MAP_OPTIONS.map((option) => (
          <li key={option.mapSize} className={`${getVisibilityClass(option)}`}>
            <button
              ...
              className={`flex-center font-body2-medium h-48pxr w-full gap-4pxr text-nowrap rounded-full border border-gray300 bg-white py-12pxr pl-20pxr pr-14pxr text-gray600 hover:text-primary100 mobile:w-auto mobile:px-15pxr mobile:text-gray700 tablet:w-auto tablet:px-15pxr`}
            >
      ...
      <button
        ...
        className={`flex-center font-body2-medium h-48pxr w-full gap-4pxr text-nowrap rounded-full border border-gray300 bg-white py-12pxr pl-20pxr pr-14pxr text-gray600 mobile:px-15pxr mobile:text-gray700 tablet:px-15pxr ${isOpen && 'mobile:border-gray30 border border-primary100 text-primary100 mobile:border-gray300 mobile:text-primary100 tablet:border-gray300'}`}
      >
