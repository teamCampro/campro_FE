export const PAGE_TYPE = {
  ...
  overview:
    'gap-16pxr mobile:px-0pxr mobile:pb-0pxr mobile:flex-col mobile:items-center',
};

export const INPUT_WRAPPER = {
  main: 'flex-center flex w-full flex-row pb-20pxr mobile:flex-col mobile:gap-12pxr tablet:flex-row tablet:px-0pxr desktop:pb-0pxr ',
  search: 'flex w-full gap-12pxr',
  overview: 'mobile:pt-20pxr flex w-full gap-12pxr',
};
