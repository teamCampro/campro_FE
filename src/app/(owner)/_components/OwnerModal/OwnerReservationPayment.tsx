...
function OwnerReservationPayment() {
  ...
  return (
    <div className='flex h-293pxr w-304pxr flex-col items-center gap-16pxr rounded-2xl border border-[#B9B9B9] px-13pxr py-20pxr'>
      ...
      <div className='flex w-full flex-col gap-12pxr'>
        ...
        <div className='flex h-82pxr flex-col gap-8pxr'>
          <div className='flex w-full justify-between'>
            <span className='text-gray600 font-body2-semibold'>추가 옵션</span>
            <span className='text-gray600 font-body2-semibold'>
              {additionalTotalPrice.toLocaleString()}원
            </span>
          </div>
          <div className='flex h-52pxr flex-col gap-8pxr overflow-y-scroll'>
