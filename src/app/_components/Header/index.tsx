...
function Header() {
  return (
    <nav className='w-full border-b border-gray200'>
      <div className='m-auto flex h-52pxr max-w-1440pxr items-center justify-between gap-10pxr px-20pxr py-[9.5px] tablet:h-80pxr tablet:gap-24pxr tablet:px-40pxr tablet:py-18pxr'>
