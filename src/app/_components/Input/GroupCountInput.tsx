  ...
  return (
    <div className='relative flex w-full flex-123 gap-4pxr'>
      ...
      <input
        ...
        className=' whitespace-nowrap w-full cursor-pointer rounded-[8px] bg-gray100 py-16pxr pl-44pxr pr-16pxr text-black placeholder-gray500 outline-none font-body2-semibold placeholder:font-body2'
        readOnly
      />
    </div>
  );
