...
function Page() {
  return (
    <div className='flex-center relative w-full flex-col items-center justify-center gap-56pxr  bg-[url("/avifs/login.png")] bg-cover bg-center bg-no-repeat pb-149pxr pt-102pxr mobile:gap-40pxr  mobile:px-20pxr mobile:pt-40pxr tablet:px-100pxr tablet:pb-124pxr tablet:pt-96pxr'>
      <div className=' flex w-full flex-col items-center justify-center'>
        ...
        <p className='flex-center tablet:font-sign-subTitle1-tablet  mobile:font-sign-subTitle1-mobile flex-nowrap gap-12pxr whitespace-nowrap font-sign-subTitle1'>
          Camping for
      ...
      <div className='flex max-w-400pxr flex-col items-center justify-center '>
        <LoginForm />
